...
class GraspNetDataset(Dataset):
    def __init__(self, root, camera='kinect', split='train', num_points=20000,
                 ...
                 augment=False, load_label=True, use_text=True):
        self.root = root
        self.split = split
        ...
        for x in tqdm(self.sceneIds, desc='Loading the scene data and its labels...'):
            for img_num in range(256):
                ...
                self.textpath.append(os.path.join(root, 'text_features', x, camera, str(img_num).zfill(4) + '.npz'))
    ...
    def _load_text_feat(self, index):
        """Return (scene_feat [512], obj_feats [MAX_OBJ,512], obj_mask [MAX_OBJ]).
    ...
    def get_data(self, index, return_raw_cloud=False):
        ...
        ret_dict['obj_feats']  = obj_feats     # [MAX_OBJ, 512]
        ret_dict['obj_mask']   = obj_mask      # [MAX_OBJ]
